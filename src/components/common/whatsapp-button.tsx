...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="whitespace-nowrap pr-5 text-base font-semibold text-white opacity-0 transition-opacity duration-200 md:group-hover:opacity-100 md:group-hover:delay-150">
        WhatsApp
      </span>
    </Link>
  );
